  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background shadow-lg transition-[transform,opacity] duration-300 ease-out will-change-transform data-[state=closed]:opacity-100 data-[state=open]:opacity-100",
          side === "right" &&
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            className="absolute right-4 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none data-[state=open]:bg-secondary"
